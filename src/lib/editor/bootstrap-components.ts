...
export const COMPONENTS: BootstrapComponentDefinition[] = [
    ...
    properties: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: "Medium (fs-5)", value: "fs-5" },
          { label: "Large (fs-4)", value: "fs-4" },
          { label: "Larger (fs-3)", value: "fs-3" },
          { label: "Extra Large (fs-2)", value: "fs-2" },
          { label: "XXL (fs-1)", value: "fs-1" },
  ...
  },
  {
    ...
    category: "typography",
    icon: "Type",
    description: "Testo semplice con colore e dimensione personalizzabili",
    properties: [
      {
        key: "text",
        label: "Testo",
        type: "text",
        defaultValue: "Testo semplice",
      ...
      },
      {
        ...
        defaultValue: "",
        options: [
          { label: "Default (1rem)", value: "" },
          { label: "Tiny (0.75rem)", value: "0.75rem" },
    ...
    properties: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: "Non valido", value: "invalid" },
        ],
      },
      {
        key: "feedbackMessage",
        label: "Messaggio feedback",
        type: "text",
        defaultValue: "",
        placeholder: "Es. Campo obbligatorio",
        group: "Validazione",
      },
    ],
  },
  ...
  // ──────────────── BUTTONS ────────────────
  {
    ...
    properties: [
      ...
      },
      {
        ...
        type: "text",
        defaultValue: "",
        placeholder: "es. house, star, gear",
        description: "Nome icona Bootstrap (senza bi-)",
      },
    ],
  },
  {
...

  {
    ...
    category: "content",
    icon: "FileText",
    description: "Costruttore guidato di form completi",
    container: true,
    properties: [
      {
        key: "formName",
      ...
      },
      {
        ...
        options: [
          { label: "Impilato (verticale)", value: "stacked" },
          { label: "Orizzontale (label a sinistra)", value: "horizontal" },
          { label: "Inline (tutto su una riga)", value: "inline" },
        ],
      },
      {
        key: "fields",
        ...
        defaultValue: JSON.stringify([
          { type: "input", label: "Nome", inputType: "text", placeholder: "Il tuo nome", required: true },
          { type: "input", label: "Email", inputType: "email", placeholder: "name@example.com", required: true },
          { type: "textarea", label: "Messaggio", placeholder: "Scrivi il tuo messaggio...", rows: 4 },
          { type: "checkbox", label: "Accetto i termini" },
        ], null, 2),
        placeholder: "Array JSON dei campi del form",
      },
      {
        key: "submitText",
      ...
      },
      {
        ...
        options: [
          ...
          { label: "Successo", value: "success" },
          { label: "Pericolo", value: "danger" },
          { label: "Outline Primario", value: "outline-primary" },
          { label: "Outline Secondario", value: "outline-secondary" },
        ],
      },
      {
        key: "showReset",
        label: "Mostra pulsante Reset",
        type: "boolean",
        defaultValue: false,
      },
      {
        key: "noValidate",
        label: "Disabilita validazione HTML5",
        type: "boolean",
        defaultValue: false,
      },
    ],
...

  {
    ...
    category: "content",
    icon: "Link",
    description: "Link (collegamento ipertestuale)",
    properties: [
      {
        key: "text",
        label: "Testo",
      ...
      },
      {
        ...
        defaultValue: "_self",
        options: [
          { label: "Stessa pagina", value: "_self" },
          { label: "Nuova scheda", value: "_blank" },
        ],
      },
      {
        key: "variant",
  ...
  },
  {
    ...
    category: "content",
    icon: "ChevronDown",
    description: "Contenuto comprimibile",
    properties: [
      {
        key: "title",
      ...
      },
      {
        ...
        placeholder: "Contenuto del collapse",
      },
      {
        key: "variant",
        label: "Variante",
      ...
      },
      {
        ...
        type: "boolean",
        defaultValue: true,
        description: "Mostra il contenuto aperto di default",
      },
      {
        key: "bordered",
        label: "Bordo",
...

  {
    ...
    category: "content",
    icon: "Columns",
    description: "Tabbed content with navigation and panes",
    properties: [
      {
        key: "items",
        label: "Elementi (etichetta|contenuto)",
        type: "textarea",
        defaultValue: "Home|Contenuto della prima tab\nProfile|Contenuto della seconda tab\nContact|Contenuto della terza tab",
        placeholder: "Etichetta|Contenuto (una per riga)",
      },
      {
        key: "active",
        label: "Tab attiva",
        type: "number",
        defaultValue: 0,
        description: "Indice della tab attiva (base 0)",
      },
      {
        key: "style",
        label: "Stile",
      ...
      },
      {
        ...
        options: [
          { label: "Nessuno", value: "" },
          { label: "Giustificato", value: "justify" },
          { label: "Riempimento", value: "fill" },
        ],
      },
      {
        key: "fade",
        label: "Transizione fade",
        type: "boolean",
        defaultValue: true,
      },
    ],
...

  {
    ...
    category: "images",
    icon: "Star",
    description: "Icona Bootstrap Icons",
    properties: [
      {
        key: "name",
        label: "Nome icona",
        type: "text",
        defaultValue: "house",
        placeholder: "es. star, heart, gear",
      },
      {
        key: "size",
        label: "Dimensione",
        ...
        defaultValue: "16",
        options: [
          { label: "Normal (1rem)", value: "16" },
          { label: "Small (0.875rem)", value: "14" },
          { label: "Medium (1.25rem)", value: "20" },
          { label: "Large (1.5rem)", value: "24" },
          { label: "Extra Large (2rem)", value: "32" },
        ],
      },
      {
        key: "color",
  ...
  },
  {
    ...
    category: "utilities",
    icon: "MessageSquare",
    description: "Tooltip su un elemento al passaggio del mouse",
    properties: [
      {
        key: "text",
        ...
        placeholder: "Testo dell'elemento trigger",
      },
      {
        key: "tooltipText",
        label: "Testo tooltip",
        ...
        placeholder: "Contenuto del tooltip",
      },
      {
        key: "placement",
        label: "Posizione",
  ...
  },
  {
    ...
    category: "utilities",
    icon: "MessageCircle",
    description: "Popover con titolo e corpo al click",
    properties: [
      {
        key: "text",
        label: "Testo pulsante",
      ...
      },
      {
        ...
        placeholder: "Titolo del popover",
      },
      {
        key: "body",
        label: "Corpo",
        type: "text",
        defaultValue: "Popover body content",
        placeholder: "Contenuto del corpo",
      },
      {
        key: "placement",
        label: "Posizione",
